...
def main(
    dataset_path: str = 'JasperHaozhe/TallyQA-EvalData-PixelReasoner',
    split: str = 'test',
    local_dir: str = 'data/pixel_reasoner/tallyqa',
    image_sep = "<image>",
):
    ...
    dataset_parquet_path = hf_hub_download(repo_id=dataset_path, filename='tallyqa_mini3200.parquet', local_dir=local_dir, repo_type='dataset')
    dataset = datasets.load_dataset('parquet', data_files=dataset_parquet_path, split='train')
