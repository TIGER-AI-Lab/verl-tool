...
VAL_FILE=${VAL_FILE:-"$(pwd)/data/mcp_universe/web_search/test.parquet"}
RUN_NAME=${RUN_NAME:-"mcp_universe-web_search"}
...
SERVERS=${SERVERS:-"google-search,fetch,notion"}
