...
VAL_FILE=${VAL_FILE:-"$(pwd)/data/mcp_universe/location_navigation/test.parquet"}
RUN_NAME=${RUN_NAME:-"mcp_universe-location_navigation"}
...
SERVERS=${SERVERS:-"google-maps,playwright,weather"}
