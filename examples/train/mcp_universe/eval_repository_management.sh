...
VAL_FILE=${VAL_FILE:-"$(pwd)/data/mcp_universe/repository_management/test.parquet"}
RUN_NAME=${RUN_NAME:-"mcp_universe-repository_management"}
...
GW_PORT=${GW_PORT:-8005}
SERVERS=${SERVERS:-"github,playwright"}
