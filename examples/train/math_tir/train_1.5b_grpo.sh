...
model_name=models/qwen2.5_math_1.5b
...
python -m verl_tool.servers.serve --host $host --port $port --tool_type "ipython_code" --workers_per_tool 256 --use_ray=True > logs/tool_server.log &
server_pid=$!
