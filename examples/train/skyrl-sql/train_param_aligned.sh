...
val_data="/map-vepfs/yi/verltool_paper/sql_experiment/verl-tool/processed_spider_datasets/test.parquet"
# model_name=/map-vepfs/yi/model_weights/Qwen2.5-Coder-7B-Instruct # should use coder model
model_name=/map-vepfs/yi/model_weights/SkyRL-SQL-7B
