...
model_name=models/wenliang_nemotron_8b_hybrid_9e-6_tool_mix_v2.3_sft_2epoch/4681_step
...
python -m verl_tool.servers.serve --host $host --port $port --tool_type "ipython_code" --workers_per_tool 256 --use_ray=True &
server_pid=$!
