...
model_name="/map-vepfs/yi/model_weights/Qwen2.5-3B" #"Qwen/Qwen2.5-3B"
...
run_name="with_kl_dapo_new_data_sglang_retriever_search_r1_qa_em-${strategy}-${model_pretty_name}-${rl_alg}-n${n}-b${batch_size}-t${temperature}-lr${lr}-${run_name_postfix}"
