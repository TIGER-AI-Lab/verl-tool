...
dataset_dir=/data/zhenxiong
train_data=[${dataset_dir}/data/${dataset_name}/test.parquet]
val_data=[${dataset_dir}/data/${dataset_name}/tiny.parquet]
...
PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True # CPU offload

max_prompt_length=16384 #should be big to avoid any truncation of audio tokens which will cause error
max_response_length=16384
max_obs_length=16384 # should be big to avoid any truncation of audio tokens which will cause error
...
gpu_memory_utilization=0.3 # lower value to leave more memory for FSDP training
...
lr=1e-6
reward_manager=audio # should be okay for simple match
