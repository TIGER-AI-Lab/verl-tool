set -x
dataset_name=acecoder/AceCode-V2-122K
...
<<<<<<< HEAD:examples/train/torl/train_qwen_7b_mtrl_v7_map.sh
    +actor_rollout_ref.model.trust_remote_code=True \
=======
    actor_rollout_ref.model.trust_remote_code=True \
>>>>>>> exp:examples/train/acecoder/train_with_tool.sh
